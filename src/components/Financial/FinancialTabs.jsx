...
const FinancialTabs = ({ tabs }) => {
    const [tabSection, setTabSection] = useState("Financial Highlights");
    return (
        <>
            <div className="mb-4 md:mt-8 mt-5 md:pb-1 pb-3  border-b border-[#fdb515] dark:border-gray-700">
                    ...
                    {tabs.map((tab) => (
                        <li
                            ...
                            className={`
                                ...
                                ${tabSection === tab.label ? "bg-[#fdb515] text-white  md:rounded-t-lg  rounded-md transition duration-100" : "text - black"}
                        `}
